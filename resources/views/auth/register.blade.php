...
<body>
    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="card">
                <center><h3><div class="card-header">{{ __('Register') }}</div></h3></center>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group mb-0">
                                ...
                                <center><p><a class="btn btn-link" href="{{ route('login') }}">{{ __('Login') }}</a></p></center>
                    </form>
                </div>
            </div>
        </div>
